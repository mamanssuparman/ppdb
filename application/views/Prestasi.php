...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Form Pendaftaran Jalur Prestasi</h1>
                    <?php 
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Add Data Pendaftar Prestasi
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">

            <form action="<?php echo base_url();?>index.php/Prestasi/save/" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-2">
                            NISN
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="tempat_lahir" placeholder="Tempat Lahir" required><input type="date" name="tgl_lahir" class="form form-control" required>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <p>
                                Bidang Prestasi <br>
                                <input type="text" name="bidang_prestasi" placeholder="Bidang Prestasi yang pernah di raih" class="form form-control" required>
                            </p>
                            <hr>
                            <p>
                                Peringkat Kejuaraan <br>
                                <input type="text" name="peringkat" placeholder="Peringkat kejuaraan " class="form form-control" required>
                            </p>
                            <hr>
                            <p>
                                Penyelenggara <br>
                                <select name="penyelenggara" id="" class="form form-control">
