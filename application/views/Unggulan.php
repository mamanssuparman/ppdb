...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Form Pendaftaran NR Unggulan</h1>
                    <?php 
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Add Data Pendaftar NR Unggulan
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">

            <form action="<?php echo base_url();?>index.php/Unggulan/save/" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-2">
                            NISN
                        </div>
