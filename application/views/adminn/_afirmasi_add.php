    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo base_url();?>index.php/adminn/Afirmasi/save/" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-2">
                            NISN
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                          <input type="file" name="lamp_akta_lahir">Lampirkan Akta Lahir
                          <input type="file" name="lamp_kk">Lampirkan Kartu Keluarga
                          <input type="file" name="lamp_kks">Lampirkan Karu lamp_kks
                          <input type="file" name="lamp_kis">Lampirkan Kartu lamp_kis
                          <input type="file" name="lamp_kip">Lampirkan Kartu lamp_kip
                          <input type="file" name="lamp_kkh">Lampirkan Kartu KKH
