    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Add Data Pendaftar Prestasi Perlombaan
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form action="<?php echo base_url();?>index.php/adminn/Perlombaan/save/" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-2">
                            NISN
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <p>
                                Bidang Prestasi <br>
                                <input type="text" name="bidang_prestasi" placeholder="Bidang Prestasi yang pernah di raih" class="form form-control">
                            </p>
                            <hr>
                            <p>
                                Peringkat Kejuaraan <br>
                                <input type="text" name="peringkat" placeholder="Peringkat kejuaraan " class="form form-control">
                            </p>
                            <hr>
                            <p>
                                Penyelenggara <br>
