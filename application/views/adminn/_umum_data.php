    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Data Pendaftar Jalur Umum
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                    <a href="<?php echo base_url();?>index.php/adminn/Umum/Add/" class="btn btn-primary btn-xs pull-right"><li class="fa fa-plus"></li>Add Pendaftaran</a>
                    </div>
                </div>
                <br>
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        <?php
                            $no=1;
                            foreach ($Data_umum->result_array() as $showdata) { ?>
                            <tr>
                                <td><?php echo $no++; ?></td>
