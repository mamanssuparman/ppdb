    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Add Data Pendaftar Perpindahan
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form action="<?php echo base_url();?>index.php/adminn/Perpindahan/save/" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-2">
                            NISN
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                          ...
                          <hr> 
                          <input type="file" name="skpt">
                          <p>
                              Lampirkan Surat Keterangan Pindah Tugas/Surat Keterangan Bertugas orang tua dari Atasan
                          </p>
                          <hr>
                          <input type="file" name="skptm">
                          <p>
                              Lampirkan Surat Keputusan Pembagian Tugas Mengajar/ Membimbing/ Membina (Bagi Guru)
                          </p>
                          <hr>
                          <input type="file" name="sertifikat_pendidik">
                          <p>
                              Lampirkan Sertifikat Pendidik (Bagi Guru)
                          </p>
                          <hr>
                        </div>
                    </div>
