...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo base_url() ;?>index.php/Login_user/Log_out"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <?php 
                $this->load->view('adminn/_partials/aside');
            ?>
            <!-- /.navbar-static-side -->
        </nav>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            <?php 
                $this->load->view('adminn/_partials/content');
            ?>
            </div>
            <!-- /.row -->
            <!-- /.row -->
