...
class Unggulan extends CI_Controller {
	...
	public function save()
	{
		...
		$this->load->model('Mdl_Adminn');
		$this->db->trans_start();
		$pencariannisn 	=$this->Mdl_Adminn->search_nisn_nik($this->input->post('nisn',TRUE),$this->input->post('nik',TRUE),$this->input->post('no_peserta_un'));
		...
		redirect('Unggulan/Cetak/'.$this->input->post('no_peserta_un',TRUE).'/'.$uri2,'refresh');
	}
